...
namespace NT106
{
    public partial class Form_QuestionUser : Form
    {
        ...
        public Form_QuestionUser(HomePage homePage, string jsonData, string username, string ipAddress)
        {
            InitializeComponent();
            AddData(jsonData);
        ...
        private void QuestionTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (TimeLimitInSeconds >= 0)
            {
                ...
                else if(TimeLimitInSeconds == 0 && isContinue ==false)
                {
                    lbNoitice.ForeColor = Color.Red;
                    lbNoitice.Text = "Bạn đã thua cuộc, Chỉ có thể đọc câu hỏi!";
                    cb25.Enabled = false;
                    cb2x.Enabled = false;
                    cb50.Enabled = false;
                    cb75.Enabled = false;   
        ...
        private async void MoveToNextQuestion(bool isContinue)
        {
            ...
            else
            {
                ...
                homePage.OpenChildForm(new Form_BXH(IpAddress));
            }
